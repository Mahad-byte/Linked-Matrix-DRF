...
class CommentAPITest(APITestCase):
    ...
    def test_create_comment_via_api(self): # TODO
        ...
        # create task
        task_data = {"title": "Task 1", "description": "do something", "project": project_id, "asignee": profile_id}
        ...
        # create comment
        comment_data = {"text": "Nice work", "author": self.user.id, "task": task_id, "project": project_id}
